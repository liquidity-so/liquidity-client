    ...
    render() {
        return (
            ...
            <div class="sign-up-in-container">
                ...
                <div class="email-input-field-sign-up-sign-in custom">@satoshinakamoto</div>
                <div class="input_field_header">Set password</div>
                <div class="email-input-field-sign-up-sign-in">New password</div>
                ...
                <div class="text-block-88">You&#x27;re currently logged in as <span class="text-span-9">johnmayson@gmail.com</span>. <br/>If you don&#x27;t intent to set up a new account, you can
                <a href="log-in.html" class="link-5"> log in with another email</a>.</div>
                </div>
            </div>
        );
    }
